 ...
 */
export function apply_move(p, o, pos) {
    const ret = wasm.apply_move(p, o, pos);
 ...
 * @returns {number}
 */
export function popcnt64(x) {
    const ret = wasm.popcnt64(x);
    return ret >>> 0;
}
 ...
 * @returns {boolean}
 */
export function has_moves(p, o) {
    const ret = wasm.has_moves(p, o);
    return ret !== 0;
}
